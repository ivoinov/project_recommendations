...
Plans:
- [ ] 03-01-PLAN.md — Candidate store models, repositories, and cache utilities
- [ ] 03-02-PLAN.md — Versioned publish service with daily batch scheduling
...
| 3. Reliable Batch Publishing and Candidate Store | 0/3 | Not started | - |
